...
from reportes.views import (
    ...
    DetalleAlumnosTutorView,
    EstadisticasTutoresView,
    ExportarEstadisticasTutoresView,
    ExportarPostulacionesPDFView,
    ExportarPostulacionesExcelView,
    ReporteEficienciaCarrerasView,
    HealthCheckView,
    DashboardChartDataView,
    ReporteGeneralPostulacionesView,
)  # FASE 4: Health check
...
urlpatterns = [
    ...
    path('reportes/postulaciones/', ReporteGeneralPostulacionesView.as_view(), name='reporte_general_postulaciones'),
    path('reportes/postulaciones/exportar/pdf/', ExportarPostulacionesPDFView.as_view(), name='exportar_postulaciones_pdf'),
    path('reportes/postulaciones/exportar/excel/', ExportarPostulacionesExcelView.as_view(), name='exportar_postulaciones_excel'),
